...
drivetrain Drivetrain = drivetrain(LeftDriveSmart, RightDriveSmart, 319.19, 295, 40, mm, 0.6);
controller Controller1 = controller(primary);

motor flywheel = motor(PORT15, ratio18_1, true);
motor rollerIntake = motor(PORT20, ratio18_1, true);

triport expander = triport(PORT13);

digital_out indexer = digital_out(expander.H);
digital_out lip = digital_out(expander.G);
digital_out expansion = digital_out(expander.F);
