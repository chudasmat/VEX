...
void farOneTriball(void) {
    chassis.set_drive_pid(55, 110, true); delay(3000);
    chassis.set_turn_pid(-40, 100); delay(1500);
    intake.move(-127);
    chassis.set_drive_pid(20, 110, true); delay(2500);
    chassis.set_drive_pid(-30, 100, true); delay(3000);
    chassis.set_drive_pid(30, 127, false); delay(3000);
    chassis.set_drive_pid(-20, 110, true); delay(1000);
    intake.brake();
    chassis.set_drive_brake(pros::E_MOTOR_BRAKE_COAST);
}
