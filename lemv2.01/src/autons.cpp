...
const int DRIVE_SPEED = 100; //pls dont kill me if this is wrong trooshan, i accidentally typed stuff
// This is 110/127 (around 87% of max speed).  We don't suggest making this 127.
