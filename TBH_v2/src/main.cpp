...
int TBH() {
  while (enableTBH) {
    ...
    tbhError = tbhGoal - currentSpeed;                                                                  // Calculate the tbhError
    if (tbhOutput + (tbhGain * tbhError) < (tbhGoal + 20)) {                                                  // Checks if integration is less than tbhGoal + margin 
      tbhOutput = tbhOutput + (tbhGain * tbhError);}                                                          // Integrates into tbhOutput if condition is met
    ...
    tbhPrevError = tbhError;                                                                            // Save the previous tbhError
