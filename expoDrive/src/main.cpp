...
void usercontrol(void) {
  ...
  while (1) {
    ...
    gearA.spin(fwd, 15.8 * (tan(M_PI * Controller1.Axis3.value()/260) + tan(M_PI * Controller1.Axis4.value()/260)), pct);  // Expo Drive (Highly Experimental)
    gearB.spin(fwd, 15.8 * (tan(M_PI * Controller1.Axis3.value()/260) - tan(M_PI * Controller1.Axis4.value()/260)),pct);
    chainA1.spin(fwd, 15.8 * (tan(M_PI * Controller1.Axis3.value()/260) - tan(M_PI * Controller1.Axis4.value()/260)),pct);
    chainA2.spin(fwd, 15.8 * (tan(M_PI * Controller1.Axis3.value()/260) - tan(M_PI * Controller1.Axis4.value()/260)),pct);
    chainB1.spin(fwd, 15.8 * (tan(M_PI * Controller1.Axis3.value()/260) + tan(M_PI * Controller1.Axis4.value()/260)),pct);  
    chainB2.spin(fwd, 15.8 * (tan(M_PI * Controller1.Axis3.value()/260) + tan(M_PI * Controller1.Axis4.value()/260)),pct);
